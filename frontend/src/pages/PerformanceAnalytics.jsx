...
const PerformanceAnalytics = () => {
  ...
  // Donut cards from learning progress
  const donutCards = [
    { title: "Learning Path", percentage: learningProgress.mycourse.avg_completion_percentage, value: learningProgress.mycourse.users_fully_completed, total: learningProgress.mycourse.total_courses_available, color: "#f97316" },
    { title: "Certificates", percentage: learningProgress.mycourse_certified.avg_completion_percentage, value: learningProgress.mycourse_certified.users_fully_completed, total: learningProgress.mycourse_certified.total_courses_available, color: "#10b981" },
    { title: "Assessment", percentage: learningProgress.quiz.avg_completion_percentage, value: learningProgress.quiz.users_fully_completed_quizzes, total: learningProgress.quiz.total_quizzes_available, color: "#3b82f6" },
    { title: "Score", percentage: learningProgress.quiz_score.avg_score_percentage, value: parseFloat(learningProgress.quiz_score.users_quiz_average__score), total: parseFloat(learningProgress.quiz_score.quizzes_average_total_score), color: "#8b5cf6" }
  ];
